...
function autoFillClicked() {
    ...
    // Get reference to all User Field 5 fields
    let userField5 = ourFrame.querySelectorAll('input[id^="USER_FIELD_5"]');
   ...
   // let userField3Array = JSON.parse(localStorage.getItem('userField3Array'));
    let userField5Array = JSON.parse(localStorage.getItem('userField5Array'));
 ...
 //       console.log('userfield3 length:', userField3.length);
        ...
        // Fill all userField5 fields with saved values
        for (let i = 0; i < userField5Array.length; i++) {
            userField5[i].value = userField5Array[i];
        }        
...
function saveDefaults() {    
    ...
    let userField5 = ourFrame.querySelectorAll('input[id^="USER_FIELD_5"]');
    console.log('userField5.length', userField5.length);
    let userField5Array = [];
    userField5.forEach( (i)=> {
        userField5Array.push(i.value);
        console.log('userField5Array[' + i + '].value: ' + i.value);
    });    
 ...
 //   localStorage.setItem('userField3Array', JSON.stringify(userField3Array));
    localStorage.setItem('userField5Array', JSON.stringify(userField5Array));
}
